...
for n_interleaf in fibo:
    article = SpiralPhyllotaxisPattern(3024,n_interleaf,time_per_acquisition=time_per_acquisition,alternated_points=True)
    article.draw(title='Article N_total = {} , {} interleaf'.format(3024,n_interleaf), alpha=0.9, marker_size=10, filter_func=only_first_interleaf)
